...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [self.containerView addSubview:self.URLButton];
        self.URL = @"rtmp://192.168.1.103:1935/rtmplive/room";
    }
    return self;
}
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        _closeButton.top = 20;
        UIImage *imgae = [UIImage imageNamed:@"LiveKitImages.bundle/close_preview"];
        [_closeButton setImage:imgae forState:UIControlStateNormal];
...
- (UIButton *)cameraButton {
    if (!_cameraButton) {
        ...
        [_cameraButton setImage:[UIImage imageNamed:@"LiveKitImages.bundle/camra_preview"] forState:UIControlStateNormal];
...
- (UIButton *)beautyButton {
    if (!_beautyButton) {
        ...
        [_beautyButton setImage:[UIImage imageNamed:@"LiveKitImages.bundle/camra_beauty"] forState:UIControlStateNormal];
        [_beautyButton setImage:[UIImage imageNamed:@"LiveKitImages.bundle/camra_beauty_close"] forState:UIControlStateSelected];
...
-(UIButton *)URLButton{
    ...
    if (!_URLButton) {
        ...
        _URLButton = [UIButton new];
        _URLButton.size = CGSizeMake(44, 44);
        _URLButton.origin = CGPointMake(_beautyButton.left - 10 - _URLButton.width, 20);
        [_URLButton setTitle:@"URL" forState:UIControlStateNormal];
        _URLButton.exclusiveTouch = YES;
        __weak typeof(self) _self = self;
        [_URLButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"URL" message:nil delegate:_self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if (buttonIndex == 1) {
        ...
        self.URL = [alertView textFieldAtIndex:0].text;
